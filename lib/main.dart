...
class Shipping {
  ...
  Shipping({
    ...
    required this.value,
  }); // set value to name in the constructor
}
...
class HalamanDua extends StatelessWidget {
  ...
  List<Shipping> _shippings = [
    Shipping(name: 'JNE', pricePerKg: 10.000, value: "JNE"),
    Shipping(name: 'J&T', pricePerKg: 20.000, value: "J&T"),
  ];

  Shipping _selectedShipping = Shipping(name: '', pricePerKg: 0, value: ' ');
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Shipping method: ${_selectedShipping.value}',
                        style: TextStyle(
                          fontSize: 16,
                        ),
                      ),
